            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h3>
                                EXAM OFFICER ACCOUNTS
                            </h3>
                            <p>This shows the verified exam officer accounts.
                                Exam Officer accounts ares used to input the applicants' entrance exam performance.</p>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $sql = $conn->prepare("SELECT * FROM `tbl_account_staff` WHERE `staff_role` = '2'");
                                            $sql->execute();
