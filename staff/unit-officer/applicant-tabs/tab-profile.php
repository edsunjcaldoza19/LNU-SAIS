                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-line">
                                                       ...
                                                       echo $fetch['program_first_choice'];?>" disabled="true">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                	<label>Program (Second Choice)</label>
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" name="program_second_choice" value="<?php echo $fetch['program_second_choice'];?>" disabled="true">
                                                    </div>
                                                </div>
                                            </div>
                                            <h2>PROFILE</h2>
