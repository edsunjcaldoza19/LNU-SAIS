                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <button type="button" class="btn btn-primary waves-effect" data-toggle="modal" data-target="#update<?php echo $fetch['id']?>">
                                            ...
                                            <td><a href="<?php echo $fetch['interview_link']; ?>"><?php echo $fetch['interview_link']; ?></a></td>
                                            ...
                                            <td align="center">
                                                <button type="button" class="btn btn-success waves-effect" data-toggle="modal" data-target="#approve<?php echo $fetch['id']?>">
                                                    <i class="material-icons">person</i>
                                                    <span>APPROVE</span>
                                                </button>
                                            </td>
                                            <td align="center">
                                                <button type="button" class="btn btn-danger waves-effect" data-toggle="modal" data-target="#reject<?php echo $fetch['id']?>">
                                                    <i class="material-icons">person</i>
                                                    <span>REJECT</span>
                                                </button>
                                            </td>
                                            ...
                                            <?php
                                            include 'interview/updateModal.php';
                                            }
                                        ?>
                                        </tr>
                                    </tbody>
