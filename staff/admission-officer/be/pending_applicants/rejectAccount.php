...
if(isset($_POST['btnConfirm'])){
    ...
    $query="UPDATE tbl_applicant_account SET `readmission_verified` = 2 WHERE `verification_key` = '$vkey'";
        ...
        //Mail body for returnee applicants
            ...
            <div class='email-body' style=' height: auto; width: auto; background-color: #F2F2F2;'>
                ...
                <div class='row' style='margin: 0px;'>
                    ...
                    <p style='font-weight: 600;'>Hi! $email, your account registration was not approved.</p>
                    <p style='text-align: justify;'>The admissions office failed to match any existing university records under your name. Kindly contact the office for more details.
                    </p>
