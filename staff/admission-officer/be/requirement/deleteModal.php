...
<div class="modal fade" id="delete<?php echo $fetch['id']?>" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form action = "be/requirement/delete.php" method="POST">
                                                    <div class="modal-header">
                                                      <h5 class="modal-title logout-modal-title">Delete Requirement</h5>
                                                      <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                      </button>
                                                    </div>
                                                    <div class="modal-body logout-modal-body">
                                                        <p class="card-dashboard-header">Are you sure you want to remove this Requirement from the database?</p>
