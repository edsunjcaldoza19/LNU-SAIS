...
<div class="user-info">
                    ...
                    ?>
                <div class="image">
                    <img src="<?php echo $image; ?>" style="border: 2px solid #0084FF;" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Hello, @<?php echo $fetch['staff_username']; ?></div>
                    <div class="email"><?php echo $fetch['staff_email']; ?></div>
